    ...
    <div v-show="isShowCitys" class="city">
      <div class="city-wrapper city-wrapper-hook">
        <div class="scroller-hook">
          <!-- <div style="text-align: center;height:3rem;line-height: 3rem;background-color: #FFF;">
            定位位置：&nbsp;&nbsp;
            <span id="qyxs" style="color:#1989fa">{{location}}</span>
          </div> -->
...
export default {
  ...
  methods: {
    ...
    //获取定位名字
    getname_CallBack: function() {
      this.$router.replace({
        path: `/personalinfoedit/${this.location}`
      });
    },
    zddw: function() {
      //初始定位
